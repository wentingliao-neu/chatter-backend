...
let MessagesService = class MessagesService {
    constructor(chatsRepository, chatsService, userService, pubSub) {
    ...
    async createMessage({ content, chatId }, userId) {
        ...
        await this.pubSub.publish(pubsub_triggers_1.MESSAGE_CREATED, { messageCreated: message });
        return message;
    }
...
exports.MessagesService = MessagesService = __decorate([
    ...
    __param(3, (0, common_1.Inject)(injection_tokens_1.PUB_SUB)),
